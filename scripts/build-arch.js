...
async function main() {
  try {
    ...
    const pkgInfoContent = [
      ...
      'optdepend = wine: Voice/Video call engine support (or use built-in portable Wine)',
      'optdepend = lib32-glibc: 32-bit runtime for Wine voice/video calls',
      'optdepend = lib32-alsa-lib: 32-bit ALSA sound support for Wine calls',
      'optdepend = lib32-libpulse: 32-bit PulseAudio sound support for Wine calls',
      'optdepend = lib32-gstreamer: 32-bit GStreamer base for video calls',
      'optdepend = lib32-gst-plugins-base: 32-bit GStreamer base plugins for video calls',
      'optdepend = lib32-gst-plugins-good: 32-bit GStreamer good plugins for video calls',
      'optdepend = lib32-libv4l: 32-bit Video4Linux camera support',
      'optdepend = v4l-utils: Camera format adjustment utility',
      ...
      'optdepend = gst-plugins-base: 64-bit GStreamer base plugins for screen bridge',
      'optdepend = gst-plugins-bad: 64-bit GStreamer bad plugins (pipewiresrc) for screen bridge',
